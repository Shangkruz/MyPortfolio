"use client"; // If this component needs client-side features like useState/useEffect, otherwise remove.
  ...
  return (
    <section className="flex flex-col items-center justify-center min-h-screen text-gray-900 px-6">
      ...
      <h1 className="mt-20 text-5xl font-extrabold tracking-tight text-white md:text-6xl">
        Hi, I&apos;m <span className="text-blue-500">Sean</span> {/* Fixed unescaped apostrophe */}
      </h1>
      ...
      <div className="mt-16 w-full max-w-4xl">
        ...
        <div className="mt-6 grid grid-cols-4 md:grid-cols-6 gap-6">
          {[
            ...
            { name: "Next.js", src: "/next.svg" }, // Assuming this is also in /public
          ...
          {[
            {
              ...
              company: "Global Venture - Promotion and Marketing Services Corp.",
